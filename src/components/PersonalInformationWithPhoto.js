...
export default function PersonalInformationWithPhoto() {
    return (
        <header className="flex flex-col mb-[10px] text-white relative">
            ...
            <a aria-label="enviar email a Lorenzo Sanchez" href="mailto:lorenzo.sanchez.dev@gmail.com" target="_blank" className="break-all text-white no-underline hover:text-bright-white transition">lorenzo.sanchez.dev@gmail.com</a>
        </header>
    )
}