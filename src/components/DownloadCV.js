...
export default function DownloadCV() {
    return (
        <section className="flex flex-col text-white">
            ...
            <a href="/cv-lorenzo-sanchez.pdf" download="CV - Lorenzo Sanchez.pdf" className="hover:scale-[1.08] transition-transform hover:cursor-pointer py-[5px] px-6 mx-auto text-center rounded mt-4">
